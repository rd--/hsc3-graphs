...
graphs_db_polyglot_autogen = do
  ...
  Polyglot.hs_graph_fragments_process_dir_set "std" db_dir (map hs_q ["Graph", "Ugen"])
  let sc_q x = "/home/rohan/sw/hsc3-graphs/lib/scd/" ++ x
  Polyglot.scd_graph_fragment_process_dir_set db_dir (map sc_q ["graph", "collect"])
  Polyglot.scd_graph_fragment_process_dir_set db_dir ["/home/rohan/sw/sc3-rdu/help/scd/"]
  sch_tbl <- Lisp.nameTableLoad "/home/rohan/sw/hsc3-lisp/lib/sch-name-tbl.text"
  let scm_q x = "/home/rohan/sw/rsc3/help/" ++ x
  Polyglot.scm_graph_fragment_process_dir_set sch_tbl ".scm" db_dir (map scm_q ["graph", "ugen"])
  Polyglot.scm_graph_fragment_process_dir_set sch_tbl ".sch" db_dir ["/home/rohan/sw/rsc3/help/graph"]
  {-
...
help =
  ...
  , ""
  , "    ext = " ++ unwords Polyglot.graphs_db_fext
  ]
...
main = do
  ...
  case a of
    ...
    "db" : "process" : ext : out_dir : in_dir -> Polyglot.graph_fragments_process_dir_set sch_tbl ext out_dir in_dir
    ["fragments", "hs", typ, "play", fn] -> Polyglot.hs_graph_fragments_process_play typ fn
    ["fragments", "hs", typ, "draw", fn] -> Polyglot.hs_graph_fragments_process_draw typ fn
    ["fragments", "hs", typ, "dump-ugens", fn] -> Polyglot.hs_graph_fragments_process_dump_ugens typ fn

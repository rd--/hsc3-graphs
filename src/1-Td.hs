...
one_td_u =
    let base = control IR "base" 2.6
        ...
        b = let x = mouseX KR 0 (choose 'a' z1) Linear 0.2
            in gbmanL AR x (rand_sym 'a' 3) (rand_sym 'b' 3) / 3
        c = let y = mouseY KR 0 (choose 'b' z1) Linear 0.2
                fr = gbmanL AR y (rand_sym 'c' 3) (rand_sym 'd' 3)
            in impulse AR (a2K fr * base / 4) 0 / 4
        d = dust 'j' AR (choose 'c' z2) / 4
        e = impulse AR (choose 'd' z2) 0 / 4
        ...
        loc = let mu = rand 'i' 0.2 0.7
                  ad = rand 'j' 0 0.3
              in lfTri KR (base / choose 'f' z5) 0 * mu + ad
        klk = let fr = randN 30 'a' 50 10000
                  ph = randN 30 'a' 0 1
                  am = randN 30 'b' 0 1
                  l = klankSpec_mce fr ph am
              in klank (choose 'g' [a,b,c,d,e,g]) 1 0 1 l

...
let p1 =
    ...
    p2 =
      ...
      , replicate 16 60 ]
    p = concatMap (\x -> concat (replicate 2 (x ++ drop 2 x))) p1 ++ concat p2
    tr = Impulse 5 0
    freq = Demand (kr tr) 0 (Dseq 1 (map MidiCps p))
in Pan2 (FreeVerb (LPF (Saw (Lag freq 0.03)) 1000) 0.3 0.5 0.35) 0 0.2

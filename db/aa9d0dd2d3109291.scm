...
(let* ((o1
        (let* ((t (Dust kr 2))
               (e (envBreakPointLinear (list 0 0 (TRand 0.05 0.5 t) 1 1 0) 1 1))
               (d (TRand 0.15 0.25 t))
               (a (EnvGen kr t (TRand 0.02 0.04 t) 0 d doNothing e))
               (p (EnvGen kr t (TRand 1.0 2.0 t) -1.0 d doNothing e))
       ...
       (shft
        (lambda ()
          (let* ((t (Impulse kr 12 0))
                 (e (envBreakPointLinear (list 0 0 (TRand 0.25 1.0 t) 1 1 0) 1 1))
       ...
       (o3
        (let* ((t (Impulse kr 6 0))
               (e (envBreakPointLinear (list 0 0 (TRand 0.25 1.0 t) 1 1 0) 1 1))
               (d (TRand 0.05 0.25 t))
               (a (EnvGen kr t (TRand 0.01 0.02 t) 0 d doNothing e))
               (p (EnvGen kr t (TRand 1.0 2.0 t) -1.0 d doNothing e))
               (n (Demand t 0 (Dibrown dinf 0 7 1)))
               (o 52)
               (b (asLocalBuf 1 (list 0 2 3.2 5 7 9 10))))

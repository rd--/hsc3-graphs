...
(let* ((shiftRegister
        (lambda (n tr x)
          (let ((buf (LocalBuf 1 n))
            ...
            (Mrg2
             (Demand tr 0 (reverse (Dbufrd buf (map (lambda (i) (Add i count)) (enumFromTo 1 n)) 1)))
       ...
       (oct (Demand tr4 0 (Drand dinf (list 12 -12))))
       (note (Demand tr1 0 (Add (Dseq dinf  (map (lambda (i) (Add i trs)) (list 42 46 51 54 59 63 66))) oct)))

...
(let* ((b (mceFromTo 8 18))
       ...
       (z (lin-lin (VarSaw ar (/ 1 81.8) 0 0.5) -1 1 (expt 1.8 -1) (/ 8.1 8.18)))
       (p (FDiv (Mul (Pluck x t (/ 1.8 181.8) d c z) (VarSaw ar (FDiv 1.8 b) 0 0.5)) 1.8)))
  (HPF (splay p 1 1 0 #t) (FDiv 18 1.81)))
